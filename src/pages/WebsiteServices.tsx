...
const content: ServicePageContent = {
  ...
  description: "A clear customer experience with the capture, follow-up, reporting, and business workflow behind it—scoped to what your business actually needs.",
  path: "/services/websites",
  seoTitle: "Websites That Run Your Business | Supreme Team Media",
  seoDescription: "Website strategy, copy, design and development, with customer capture, follow-up and business systems scoped around the way your company works.",
  intent: "websites",

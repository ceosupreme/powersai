...
const PAGE_COPY = {
  ...
  es: {
    ...
    inquiryEyebrow: "Una primera conversación práctica", inquiryTitle: "Cuéntame dónde se desconecta el crecimiento.", inquiryBody: "Elige las prioridades y agrega el contexto importante. Recibirás una respuesta directa, no una secuencia automática de ventas.", selfGuided: "¿Prefieres empezar por tu cuenta? Haz la revisión gratis", mainForm: "O usa el formulario principal",

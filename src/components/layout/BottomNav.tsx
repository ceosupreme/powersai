...
const secondaryNavItems = [
  ...
  { to: '/automations/inbox', icon: Zap, label: 'Automation Inbox', pageKey: 'automation_inbox' as PageKey },
  { to: '/automations/recovery-reports', icon: FileText, label: 'Recovery Reports', pageKey: 'recovery_reports' as PageKey },
  { to: '/leak-stack', icon: Activity, label: 'Leak Stack', pageKey: 'leak_stack' as PageKey },
  { to: '/templates', icon: MessageSquare, label: 'Templates', pageKey: 'outreach_templates' as PageKey },
